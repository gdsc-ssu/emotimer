package com.example.authservice.oauth.service;

import com.example.authservice.api.entity.user.User;
import com.example.authservice.api.repository.user.UserRepository;
import com.example.authservice.oauth.entity.ProviderType;
import com.example.authservice.oauth.entity.RoleType;
import com.example.authservice.oauth.entity.UserPrincipal;
import com.example.authservice.oauth.exception.OAuthProviderMissMatchException;
import com.example.authservice.oauth.info.OAuth2UserInfo;
import com.example.authservice.oauth.info.OAuth2UserInfoFactory;
