...
class YearlyStaticsPage extends StatefulWidget {
  YearlyStaticsPage({Key? key}) : super(key: key);
  ...
  @override
  _YearlyStaticsPageState createState() => _YearlyStaticsPageState();
}

class _YearlyStaticsPageState extends State<YearlyStaticsPage> {
  @override
  Widget build(BuildContext context) {
    return Statics(
      ...
      // data: widget.data,
      data: [],
      listRankingTitle: "Yearly Ranking",
      ranking: widget.ranking,
      pageCount: 3,
      pageTitleRenderer: (index) => "$index Year",
      onChangePage: (index) {},
      skeletonChartBarCount: 12,
    );
  }
}
